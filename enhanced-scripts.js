    ...
    function initCollaborationMap() {
      ...
      try {
        ...
        const locations = [
          {
            ...
            coords: [35.88, -106.3031],
            city: "Los Alamos, NM, USA",
            publications: [
              "Chiroptical Response (2025)",
              "Perylene Diimide Trimers (2025)",
            ],
          ...
          {
            name: "UC Merced (UCM)",
            coords: [37.3661, -120.425],
            city: "Merced, CA, USA",
            publications: [
              "Optical Spectroscopy (2021)",
              "Franck-Condon Methods (2024)",
            ],
          ...
          },
          {
            ...
            publications: ["Molecular Polariton (2022)"],
            collaborator:
              "Noel C. Giebink, Chiao-Yu Cheng, Nina Krainova, Alyssa Brigeman",
          },
          {
          ...
          },
          {
            ...
            collaborator:
              "Rakesh Parida, G. Naaresh Reddy, Gourisankar Roymahapatra, Santanab Giri",
          },
        ];
        ...
        locations.forEach((loc) => {
          ...
          let popupContent = `
            <div class="map-popup">
              ...
              ${
                loc.collaborator
                  ? `<p>Collaborator: ${loc.collaborator}</p>`
                  : ""
              }
              ...
              <span class="publication-count">${
                loc.publications.length
              } publication${loc.publications.length > 1 ? "s" : ""}</span>
            </div>
          `;
          ...
          if (!loc.isHome) {
            const homeCoords = locations.find(
              (l) =>
                l.isHome && l.name === "Los Alamos National Laboratory (LANL)"
            );
            if (homeCoords) {
        ...
        legend.onAdd = function () {
          ...
          div.style.cssText =
            "background: white; padding: 12px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.15);";
          div.innerHTML = `
